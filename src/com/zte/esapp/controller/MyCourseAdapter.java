...
public class MyCourseAdapter extends BaseAdapter{
    ...
    public MyCourseAdapter(Context context, List<CourseTop> mData, ListView listView) {
        this.mData = mData;
        mContext = context;
    ...
    public View getView(int position, View convertView , ViewGroup viewGroup) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.item_course,viewGroup,false);
            ...
            holder.course_hour = (TextView) convertView.findViewById(R.id.course_hour);
            holder.course_minute = (TextView) convertView.findViewById(R.id.course_minute);
            holder.course_name = (TextView) convertView.findViewById(R.id.course_name);
            holder.course_num = (TextView) convertView.findViewById(R.id.course_num);
            holder.course_people = (TextView) convertView.findViewById(R.id.course_people);
...
//        image
        ...
        holder.course_hour.setText(courseTop.getCourseLength()/60 +"");
        holder.course_minute.setText(courseTop.getCourseLength()%60 + "");
        holder.course_name.setText(courseTop.getCourseName());
        holder.course_num.setText(courseTop.getCourseNum()+"");
        holder.course_people.setText(courseTop.getCoursePeople()+"");
    ...
    public class ViewHolder{
        ...
        private TextView course_name,course_author,course_hour,course_minute,course_num,course_people,course_price;
    }
